...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Álbum Copa 2026 — Gerenciador de Trocas" },
      { name: "description", content: "Gerencie sua coleção de figurinhas da Copa do Mundo 2026 e registre suas trocas com amigos." },
    ],
